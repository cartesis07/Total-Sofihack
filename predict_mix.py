...
for subdir, dirs, files in os.walk(folder_2019):
    for file in files:
        ...
        np.savetxt("Hackathon_Data/Dataset/Prediction1/Outputs/" + 'output' + file, pred, header="Consommation (MW),Thermique (MW),Nucléaire (MW),Eolien (MW),Solaire (MW),Hydraulique (MW),Pompage (MW),Bioénergies (MW),Ech. physiques (MW)", delimiter=',')
