...
dense_layer_1 = layers.Dense(200, activation='relu')(input_layer)
dense_layer_2 = layers.Dense(100, activation='relu')(dense_layer_1)
dense_layer_3 = layers.Dense(50, activation='relu')(dense_layer_2)
...
df2019 = pd.read_csv('cost_predicted/total_2019.csv',usecols=pred_selection)
...
df2019.to_csv('results_predicted/total_2019_cost.csv')

df2020 = pd.read_csv('cost_predicted/total_2020.csv',usecols=pred_selection)
...
df2020.to_csv('results_predicted/total_2020_cost.csv')